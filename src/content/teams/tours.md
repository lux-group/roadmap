...
goals:
  - headline: "Improve gross margin"
    description: "Current: 10.8M → Target: 13.5M"
  - headline: "Increase total transaction value"
    description: "Current: baseline → Target: material growth via private tours and personalization"
  - headline: "Unlock private tours as high-value revenue stream"
    description: "Current: disabled → Target: 3-4M annually at 35-40% GM"
  - headline: "Achieve operational efficiency and scalability"
    description: "Current: manual processes and inconsistencies → Target: streamlined ops via Kaptio and improved inventory management"
  - headline: "Enable trip personalization and bundling"
    description: "Current: pre-defined packages only → Target: custom trip planning and cross-vertical bundling"
