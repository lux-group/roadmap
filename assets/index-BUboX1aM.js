 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */var f=reactExports,k=Symbol.for("react.element"),l=Symbol.for("react.fragment"),m$1=Object.prototype.hasOwnProperty,n=f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,p$1={key:!0,ref:!0,__self:!0,__source:!0};function q(e,o,a){var s,c={},d=null,h=null;a!==void 0&&(d=""+a),o.key!==void 0&&(d=""+o.key),o.ref!==void 0&&(h=o.ref);for(s in o)m$1.call(o,s)&&!p$1.hasOwnProperty(s)&&(c[s]=o[s]);if(e&&e.defaultProps)for(s in o=e.defaultProps,o)c[s]===void 0&&(c[s]=o[s]);return{$$typeof:k,type:e,key:d,ref:h,props:c,_owner:n.current}}reactJsxRuntime_production_min.Fragment=l;reactJsxRuntime_production_min.jsx=q;reactJsxRuntime_production_min.jsxs=q;jsxRuntime.exports=reactJsxRuntime_production_min;var jsxRuntimeExports=jsxRuntime.exports,buffer={},base64Js={};base64Js.byteLength=byteLength;base64Js.toByteArray=toByteArray;base64Js.fromByteArray=fromByteArray;var lookup=[],revLookup=[],Arr=typeof Uint8Array<"u"?Uint8Array:Array,code="ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/";for(var i$1=0,len=code.length;i$1<len;++i$1)lookup[i$1]=code[i$1],revLookup[code.charCodeAt(i$1)]=i$1;revLookup[45]=62;revLookup[95]=63;function getLens(e){var o=e.length;if(o%4>0)throw new Error("Invalid string. Length must be a multiple of 4");var a=e.indexOf("=");a===-1&&(a=o);var s=a===o?0:4-a%4;return[a,s]}function byteLength(e){var o=getLens(e),a=o[0],s=o[1];return(a+s)*3/4-s}function _byteLength(e,o,a){return(o+a)*3/4-a}function toByteArray(e){var o,a=getLens(e),s=a[0],c=a[1],d=new Arr(_byteLength(e,s,c)),h=0,g=c>0?s-4:s,b;for(b=0;b<g;b+=4)o=revLookup[e.charCodeAt(b)]<<18|revLookup[e.charCodeAt(b+1)]<<12|revLookup[e.charCodeAt(b+2)]<<6|revLookup[e.charCodeAt(b+3)],d[h++]=o>>16&255,d[h++]=o>>8&255,d[h++]=o&255;return c===2&&(o=revLookup[e.charCodeAt(b)]<<2|revLookup[e.charCodeAt(b+1)]>>4,d[h++]=o&255),c===1&&(o=revLookup[e.charCodeAt(b)]<<10|revLookup[e.charCodeAt(b+1)]<<4|revLookup[e.charCodeAt(b+2)]>>2,d[h++]=o>>8&255,d[h++]=o&255),d}function tripletToBase64(e){return lookup[e>>18&63]+lookup[e>>12&63]+lookup[e>>6&63]+lookup[e&63]}function encodeChunk(e,o,a){for(var s,c=[],d=o;d<a;d+=3)s=(e[d]<<16&16711680)+(e[d+1]<<8&65280)+(e[d+2]&255),c.push(tripletToBase64(s));return c.join("")}function fromByteArray(e){for(var o,a=e.length,s=a%3,c=[],d=16383,h=0,g=a-s;h<g;h+=d)c.push(encodeChunk(e,h,h+d>g?g:h+d));return s===1?(o=e[a-1],c.push(lookup[o>>2]+lookup[o<<4&63]+"==")):s===2&&(o=(e[a-2]<<8)+e[a-1],c.push(lookup[o>>10]+lookup[o>>4&63]+lookup[o<<2&63]+"=")),c.join("")}var ieee754={};/*! ieee754. BSD-3-Clause License. Feross Aboukhadijeh <https://feross.org/opensource> */ieee754.read=function(e,o,a,s,c){var d,h,g=c*8-s-1,b=(1<<g)-1,$=b>>1,tt=-7,et=a?c-1:0,nt=a?-1:1,ot=e[o+et];for(et+=nt,d=ot&(1<<-tt)-1,ot>>=-tt,tt+=g;tt>0;d=d*256+e[o+et],et+=nt,tt-=8);for(h=d&(1<<-tt)-1,d>>=-tt,tt+=s;tt>0;h=h*256+e[o+et],et+=nt,tt-=8);if(d===0)d=1-$;else{if(d===b)return h?NaN:(ot?-1:1)*(1/0);h=h+Math.pow(2,s),d=d-$}return(ot?-1:1)*h*Math.pow(2,d-s)};ieee754.write=function(e,o,a,s,c,d){var h,g,b,$=d*8-c-1,tt=(1<<$)-1,et=tt>>1,nt=c===23?Math.pow(2,-24)-Math.pow(2,-77):0,ot=s?0:d-1,ft=s?1:-1,pt=o<0||o===0&&1/o<0?1:0;for(o=Math.abs(o),isNaN(o)||o===1/0?(g=isNaN(o)?1:0,h=tt):(h=Math.floor(Math.log(o)/Math.LN2),o*(b=Math.pow(2,-h))<1&&(h--,b*=2),h+et>=1?o+=nt/b:o+=nt*Math.pow(2,1-et),o*b>=2&&(h++,b/=2),h+et>=tt?(g=0,h=tt):h+et>=1?(g=(o*b-1)*Math.pow(2,c),h=h+et):(g=o*Math.pow(2,et-1)*Math.pow(2,c),h=0));c>=8;e[a+ot]=g&255,ot+=ft,g/=256,c-=8);for(h=h<<c|g,$+=c;$>0;e[a+ot]=h&255,ot+=ft,h/=256,$-=8);e[a+ot-ft]|=pt*128};/*!
 * The buffer module from node.js, for the browser.
 *
 * @author   Feross Aboukhadijeh <https://feross.org>
 * @license  MIT
 */(function(e){const o=base64Js,a=ieee754,s=typeof Symbol=="function"&&typeof Symbol.for=="function"?Symbol.for("nodejs.util.inspect.custom"):null;e.Buffer=g,e.SlowBuffer=it,e.INSPECT_MAX_BYTES=50;const c=2147483647;e.kMaxLength=c,g.TYPED_ARRAY_SUPPORT=d(),!g.TYPED_ARRAY_SUPPORT&&typeof console<"u"&&typeof console.error=="function"&&console.error("This browser lacks typed array (Uint8Array) support which is required by `buffer` v5.x. Use `buffer` v4.x if you require old browser support.");function d(){try{const _e=new Uint8Array(1),_={foo:function(){return 42}};return Object.setPrototypeOf(_,Uint8Array.prototype),Object.setPrototypeOf(_e,_),_e.foo()===42}catch{return!1}}Object.defineProperty(g.prototype,"parent",{enumerable:!0,get:function(){if(g.isBuffer(this))return this.buffer}}),Object.defineProperty(g.prototype,"offset",{enumerable:!0,get:function(){if(g.isBuffer(this))return this.byteOffset}});function h(_e){if(_e>c)throw new RangeError('The value "'+_e+'" is invalid for option "size"');const _=new Uint8Array(_e);return Object.setPrototypeOf(_,g.prototype),_}function g(_e,_,j){if(typeof _e=="number"){if(typeof _=="string")throw new TypeError('The "string" argument must be of type string. Received type number');return et(_e)}return b(_e,_,j)}g.poolSize=8192;function b(_e,_,j){if(typeof _e=="string")return nt(_e,_);if(ArrayBuffer.isView(_e))return ft(_e);if(_e==null)throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof _e);if(dn(_e,ArrayBuffer)||_e&&dn(_e.buffer,ArrayBuffer)||typeof SharedArrayBuffer<"u"&&(dn(_e,SharedArrayBuffer)||_e&&dn(_e.buffer,SharedArrayBuffer)))return pt(_e,_,j);if(typeof _e=="number")throw new TypeError('The "value" argument must not be of type number. Received type number');const rt=_e.valueOf&&_e.valueOf();if(rt!=null&&rt!==_e)return g.from(rt,_,j);const ut=vt(_e);if(ut)return ut;if(typeof Symbol<"u"&&Symbol.toPrimitive!=null&&typeof _e[Symbol.toPrimitive]=="function")return g.from(_e[Symbol.toPrimitive]("string"),_,j);throw new TypeError("The first argument must be one of type string, Buffer, ArrayBuffer, Array, or Array-like Object. Received type "+typeof _e)}g.from=function(_e,_,j){return b(_e,_,j)},Object.setPrototypeOf(g.prototype,Uint8Array.prototype),Object.setPrototypeOf(g,Uint8Array);function $(_e){if(typeof _e!="number")throw new TypeError('"size" argument must be of type number');if(_e<0)throw new RangeError('The value "'+_e+'" is invalid for option "size"')}function tt(_e,_,j){return $(_e),_e<=0?h(_e):_!==void 0?typeof j=="string"?h(_e).fill(_,j):h(_e).fill(_):h(_e)}g.alloc=function(_e,_,j){return tt(_e,_,j)};function et(_e){return $(_e),h(_e<0?0:lt(_e)|0)}g.allocUnsafe=function(_e){return et(_e)},g.allocUnsafeSlow=function(_e){return et(_e)};function nt(_e,_){if((typeof _!="string"||_==="")&&(_="utf8"),!g.isEncoding(_))throw new TypeError("Unknown encoding: "+_);const j=st(_e,_)|0;let rt=h(j);const ut=rt.write(_e,_);return ut!==j&&(rt=rt.slice(0,ut)),rt}function ot(_e){const _=_e.length<0?0:lt(_e.length)|0,j=h(_);for(let rt=0;rt<_;rt+=1)j[rt]=_e[rt]&255;return j}function ft(_e){if(dn(_e,Uint8Array)){const _=new Uint8Array(_e);return pt(_.buffer,_.byteOffset,_.byteLength)}return ot(_e)}function pt(_e,_,j){if(_<0||_e.byteLength<_)throw new RangeError('"offset" is outside of buffer bounds');if(_e.byteLength<_+(j||0))throw new RangeError('"length" is outside of buffer bounds');let rt;return _===void 0&&j===void 0?rt=new Uint8Array(_e):j===void 0?rt=new Uint8Array(_e,_):rt=new Uint8Array(_e,_,j),Object.setPrototypeOf(rt,g.prototype),rt}function vt(_e){if(g.isBuffer(_e)){const _=lt(_e.length)|0,j=h(_);return j.length===0||_e.copy(j,0,0,_),j}if(_e.length!==void 0)return typeof _e.length!="number"||Pn(_e.length)?h(0):ot(_e);if(_e.type==="Buffer"&&Array.isArray(_e.data))return ot(_e.data)}function lt(_e){if(_e>=c)throw new RangeError("Attempt to allocate Buffer larger than maximum size: 0x"+c.toString(16)+" bytes");return _e|0}function it(_e){return+_e!=_e&&(_e=0),g.alloc(+_e)}g.isBuffer=function(_){return _!=null&&_._isBuffer===!0&&_!==g.prototype},g.compare=function(_,j){if(dn(_,Uint8Array)&&(_=g.from(_,_.offset,_.byteLength)),dn(j,Uint8Array)&&(j=g.from(j,j.offset,j.byteLength)),!g.isBuffer(_)||!g.isBuffer(j))throw new TypeError('The "buf1", "buf2" arguments must be one of type Buffer or Uint8Array');if(_===j)return 0;let rt=_.length,ut=j.length;for(let ht=0,gt=Math.min(rt,ut);ht<gt;++ht)if(_[ht]!==j[ht]){rt=_[ht],ut=j[ht];break}return rt<ut?-1:ut<rt?1:0},g.isEncoding=function(_){switch(String(_).toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"latin1":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return!0;default:return!1}},g.concat=function(_,j){if(!Array.isArray(_))throw new TypeError('"list" argument must be an Array of Buffers');if(_.length===0)return g.alloc(0);let rt;if(j===void 0)for(j=0,rt=0;rt<_.length;++rt)j+=_[rt].length;const ut=g.allocUnsafe(j);let ht=0;for(rt=0;rt<_.length;++rt){let gt=_[rt];if(dn(gt,Uint8Array))ht+gt.length>ut.length?(g.isBuffer(gt)||(gt=g.from(gt)),gt.copy(ut,ht)):Uint8Array.prototype.set.call(ut,gt,ht);else if(g.isBuffer(gt))gt.copy(ut,ht);else throw new TypeError('"list" argument must be an Array of Buffers');ht+=gt.length}return ut};function st(_e,_){if(g.isBuffer(_e))return _e.length;if(ArrayBuffer.isView(_e)||dn(_e,ArrayBuffer))return _e.byteLength;if(typeof _e!="string")throw new TypeError('The "string" argument must be one of type string, Buffer, or ArrayBuffer. Received type '+typeof _e);const j=_e.length,rt=arguments.length>2&&arguments[2]===!0;if(!rt&&j===0)return 0;let ut=!1;for(;;)switch(_){case"ascii":case"latin1":case"binary":return j;case"utf8":case"utf-8":return Rn(_e).length;case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return j*2;case"hex":return j>>>1;case"base64":return In(_e).length;default:if(ut)return rt?-1:Rn(_e).length;_=(""+_).toLowerCase(),ut=!0}}g.byteLength=st;function yt(_e,_,j){let rt=!1;if((_===void 0||_<0)&&(_=0),_>this.length||((j===void 0||j>this.length)&&(j=this.length),j<=0)||(j>>>=0,_>>>=0,j<=_))return"";for(_e||(_e="utf8");;)switch(_e){case"hex":return Lt(this,_,j);case"utf8":case"utf-8":return Jt(this,_,j);case"ascii":return hn(this,_,j);case"latin1":case"binary":return wt(this,_,j);case"base64":return qt(this,_,j);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Mt(this,_,j);default:if(rt)throw new TypeError("Unknown encoding: "+_e);_e=(_e+"").toLowerCase(),rt=!0}}g.prototype._isBuffer=!0;function _t(_e,_,j){const rt=_e[_];_e[_]=_e[j],_e[j]=rt}g.prototype.swap16=function(){const _=this.length;if(_%2!==0)throw new RangeError("Buffer size must be a multiple of 16-bits");for(let j=0;j<_;j+=2)_t(this,j,j+1);return this},g.prototype.swap32=function(){const _=this.length;if(_%4!==0)throw new RangeError("Buffer size must be a multiple of 32-bits");for(let j=0;j<_;j+=4)_t(this,j,j+3),_t(this,j+1,j+2);return this},g.prototype.swap64=function(){const _=this.length;if(_%8!==0)throw new RangeError("Buffer size must be a multiple of 64-bits");for(let j=0;j<_;j+=8)_t(this,j,j+7),_t(this,j+1,j+6),_t(this,j+2,j+5),_t(this,j+3,j+4);return this},g.prototype.toString=function(){const _=this.length;return _===0?"":arguments.length===0?Jt(this,0,_):yt.apply(this,arguments)},g.prototype.toLocaleString=g.prototype.toString,g.prototype.equals=function(_){if(!g.isBuffer(_))throw new TypeError("Argument must be a Buffer");return this===_?!0:g.compare(this,_)===0},g.prototype.inspect=function(){let _="";const j=e.INSPECT_MAX_BYTES;return _=this.toString("hex",0,j).replace(/(.{2})/g,"$1 ").trim(),this.length>j&&(_+=" ... "),"<Buffer "+_+">"},s&&(g.prototype[s]=g.prototype.inspect),g.prototype.compare=function(_,j,rt,ut,ht){if(dn(_,Uint8Array)&&(_=g.from(_,_.offset,_.byteLength)),!g.isBuffer(_))throw new TypeError('The "target" argument must be one of type Buffer or Uint8Array. Received type '+typeof _);if(j===void 0&&(j=0),rt===void 0&&(rt=_?_.length:0),ut===void 0&&(ut=0),ht===void 0&&(ht=this.length),j<0||rt>_.length||ut<0||ht>this.length)throw new RangeError("out of range index");if(ut>=ht&&j>=rt)return 0;if(ut>=ht)return-1;if(j>=rt)return 1;if(j>>>=0,rt>>>=0,ut>>>=0,ht>>>=0,this===_)return 0;let gt=ht-ut,Ft=rt-j;const Gt=Math.min(gt,Ft),Vt=this.slice(ut,ht),Kt=_.slice(j,rt);for(let Ht=0;Ht<Gt;++Ht)if(Vt[Ht]!==Kt[Ht]){gt=Vt[Ht],Ft=Kt[Ht];break}return gt<Ft?-1:Ft<gt?1:0};function Ct(_e,_,j,rt,ut){if(_e.length===0)return-1;if(typeof j=="string"?(rt=j,j=0):j>2147483647?j=2147483647:j<-2147483648&&(j=-2147483648),j=+j,Pn(j)&&(j=ut?0:_e.length-1),j<0&&(j=_e.length+j),j>=_e.length){if(ut)return-1;j=_e.length-1}else if(j<0)if(ut)j=0;else return-1;if(typeof _=="string"&&(_=g.from(_,rt)),g.isBuffer(_))return _.length===0?-1:ct(_e,_,j,rt,ut);if(typeof _=="number")return _=_&255,typeof Uint8Array.prototype.indexOf=="function"?ut?Uint8Array.prototype.indexOf.call(_e,_,j):Uint8Array.prototype.lastIndexOf.call(_e,_,j):ct(_e,[_],j,rt,ut);throw new TypeError("val must be string, number or Buffer")}function ct(_e,_,j,rt,ut){let ht=1,gt=_e.length,Ft=_.length;if(rt!==void 0&&(rt=String(rt).toLowerCase(),rt==="ucs2"||rt==="ucs-2"||rt==="utf16le"||rt==="utf-16le")){if(_e.length<2||_.length<2)return-1;ht=2,gt/=2,Ft/=2,j/=2}function Gt(Kt,Ht){return ht===1?Kt[Ht]:Kt.readUInt16BE(Ht*ht)}let Vt;if(ut){let Kt=-1;for(Vt=j;Vt<gt;Vt++)if(Gt(_e,Vt)===Gt(_,Kt===-1?0:Vt-Kt)){if(Kt===-1&&(Kt=Vt),Vt-Kt+1===Ft)return Kt*ht}else Kt!==-1&&(Vt-=Vt-Kt),Kt=-1}else for(j+Ft>gt&&(j=gt-Ft),Vt=j;Vt>=0;Vt--){let Kt=!0;for(let Ht=0;Ht<Ft;Ht++)if(Gt(_e,Vt+Ht)!==Gt(_,Ht)){Kt=!1;break}if(Kt)return Vt}return-1}g.prototype.includes=function(_,j,rt){return this.indexOf(_,j,rt)!==-1},g.prototype.indexOf=function(_,j,rt){return Ct(this,_,j,rt,!0)},g.prototype.lastIndexOf=function(_,j,rt){return Ct(this,_,j,rt,!1)};function Et(_e,_,j,rt){j=Number(j)||0;const ut=_e.length-j;rt?(rt=Number(rt),rt>ut&&(rt=ut)):rt=ut;const ht=_.length;rt>ht/2&&(rt=ht/2);let gt;for(gt=0;gt<rt;++gt){const Ft=parseInt(_.substr(gt*2,2),16);if(Pn(Ft))return gt;_e[j+gt]=Ft}return gt}function jt(_e,_,j,rt){return _n(Rn(_,_e.length-j),_e,j,rt)}function kt(_e,_,j,rt){return _n(zn(_),_e,j,rt)}function zt(_e,_,j,rt){return _n(In(_),_e,j,rt)}function Wt(_e,_,j,rt){return _n(Ln(_,_e.length-j),_e,j,rt)}g.prototype.write=function(_,j,rt,ut){if(j===void 0)ut="utf8",rt=this.length,j=0;else if(rt===void 0&&typeof j=="string")ut=j,rt=this.length,j=0;else if(isFinite(j))j=j>>>0,isFinite(rt)?(rt=rt>>>0,ut===void 0&&(ut="utf8")):(ut=rt,rt=void 0);else throw new Error("Buffer.write(string, encoding, offset[, length]) is no longer supported");const ht=this.length-j;if((rt===void 0||rt>ht)&&(rt=ht),_.length>0&&(rt<0||j<0)||j>this.length)throw new RangeError("Attempt to write outside buffer bounds");ut||(ut="utf8");let gt=!1;for(;;)switch(ut){case"hex":return Et(this,_,j,rt);case"utf8":case"utf-8":return jt(this,_,j,rt);case"ascii":case"latin1":case"binary":return kt(this,_,j,rt);case"base64":return zt(this,_,j,rt);case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return Wt(this,_,j,rt);default:if(gt)throw new TypeError("Unknown encoding: "+ut);ut=(""+ut).toLowerCase(),gt=!0}},g.prototype.toJSON=function(){return{type:"Buffer",data:Array.prototype.slice.call(this._arr||this,0)}};function qt(_e,_,j){return _===0&&j===_e.length?o.fromByteArray(_e):o.fromByteArray(_e.slice(_,j))}function Jt(_e,_,j){j=Math.min(_e.length,j);const rt=[];let ut=_;for(;ut<j;){const ht=_e[ut];let gt=null,Ft=ht>239?4:ht>223?3:ht>191?2:1;if(ut+Ft<=j){let Gt,Vt,Kt,Ht;switch(Ft){case 1:ht<128&&(gt=ht);break;case 2:Gt=_e[ut+1],(Gt&192)===128&&(Ht=(ht&31)<<6|Gt&63,Ht>127&&(gt=Ht));break;case 3:Gt=_e[ut+1],Vt=_e[ut+2],(Gt&192)===128&&(Vt&192)===128&&(Ht=(ht&15)<<12|(Gt&63)<<6|Vt&63,Ht>2047&&(Ht<55296||Ht>57343)&&(gt=Ht));break;case 4:Gt=_e[ut+1],Vt=_e[ut+2],Kt=_e[ut+3],(Gt&192)===128&&(Vt&192)===128&&(Kt&192)===128&&(Ht=(ht&15)<<18|(Gt&63)<<12|(Vt&63)<<6|Kt&63,Ht>65535&&Ht<1114112&&(gt=Ht))}}gt===null?(gt=65533,Ft=1):gt>65535&&(gt-=65536,rt.push(gt>>>10&1023|55296),gt=56320|gt&1023),rt.push(gt),ut+=Ft}return pn(rt)}const ln=4096;function pn(_e){const _=_e.length;if(_<=ln)return String.fromCharCode.apply(String,_e);let j="",rt=0;for(;rt<_;)j+=String.fromCharCode.apply(String,_e.slice(rt,rt+=ln));return j}function hn(_e,_,j){let rt="";j=Math.min(_e.length,j);for(let ut=_;ut<j;++ut)rt+=String.fromCharCode(_e[ut]&127);return rt}function wt(_e,_,j){let rt="";j=Math.min(_e.length,j);for(let ut=_;ut<j;++ut)rt+=String.fromCharCode(_e[ut]);return rt}function Lt(_e,_,j){const rt=_e.length;(!_||_<0)&&(_=0),(!j||j<0||j>rt)&&(j=rt);let ut="";for(let ht=_;ht<j;++ht)ut+=yn[_e[ht]];return ut}function Mt(_e,_,j){const rt=_e.slice(_,j);let ut="";for(let ht=0;ht<rt.length-1;ht+=2)ut+=String.fromCharCode(rt[ht]+rt[ht+1]*256);return ut}g.prototype.slice=function(_,j){const rt=this.length;_=~~_,j=j===void 0?rt:~~j,_<0?(_+=rt,_<0&&(_=0)):_>rt&&(_=rt),j<0?(j+=rt,j<0&&(j=0)):j>rt&&(j=rt),j<_&&(j=_);const ut=this.subarray(_,j);return Object.setPrototypeOf(ut,g.prototype),ut};function It(_e,_,j){if(_e%1!==0||_e<0)throw new RangeError("offset is not uint");if(_e+_>j)throw new RangeError("Trying to access beyond buffer length")}g.prototype.readUintLE=g.prototype.readUIntLE=function(_,j,rt){_=_>>>0,j=j>>>0,rt||It(_,j,this.length);let ut=this[_],ht=1,gt=0;for(;++gt<j&&(ht*=256);)ut+=this[_+gt]*ht;return ut},g.prototype.readUintBE=g.prototype.readUIntBE=function(_,j,rt){_=_>>>0,j=j>>>0,rt||It(_,j,this.length);let ut=this[_+--j],ht=1;for(;j>0&&(ht*=256);)ut+=this[_+--j]*ht;return ut},g.prototype.readUint8=g.prototype.readUInt8=function(_,j){return _=_>>>0,j||It(_,1,this.length),this[_]},g.prototype.readUint16LE=g.prototype.readUInt16LE=function(_,j){return _=_>>>0,j||It(_,2,this.length),this[_]|this[_+1]<<8},g.prototype.readUint16BE=g.prototype.readUInt16BE=function(_,j){return _=_>>>0,j||It(_,2,this.length),this[_]<<8|this[_+1]},g.prototype.readUint32LE=g.prototype.readUInt32LE=function(_,j){return _=_>>>0,j||It(_,4,this.length),(this[_]|this[_+1]<<8|this[_+2]<<16)+this[_+3]*16777216},g.prototype.readUint32BE=g.prototype.readUInt32BE=function(_,j){return _=_>>>0,j||It(_,4,this.length),this[_]*16777216+(this[_+1]<<16|this[_+2]<<8|this[_+3])},g.prototype.readBigUInt64LE=un(function(_){_=_>>>0,cn(_,"offset");const j=this[_],rt=this[_+7];(j===void 0||rt===void 0)&&xn(_,this.length-8);const ut=j+this[++_]*2**8+this[++_]*2**16+this[++_]*2**24,ht=this[++_]+this[++_]*2**8+this[++_]*2**16+rt*2**24;return BigInt(ut)+(BigInt(ht)<<BigInt(32))}),g.prototype.readBigUInt64BE=un(function(_){_=_>>>0,cn(_,"offset");const j=this[_],rt=this[_+7];(j===void 0||rt===void 0)&&xn(_,this.length-8);const ut=j*2**24+this[++_]*2**16+this[++_]*2**8+this[++_],ht=this[++_]*2**24+this[++_]*2**16+this[++_]*2**8+rt;return(BigInt(ut)<<BigInt(32))+BigInt(ht)}),g.prototype.readIntLE=function(_,j,rt){_=_>>>0,j=j>>>0,rt||It(_,j,this.length);let ut=this[_],ht=1,gt=0;for(;++gt<j&&(ht*=256);)ut+=this[_+gt]*ht;return ht*=128,ut>=ht&&(ut-=Math.pow(2,8*j)),ut},g.prototype.readIntBE=function(_,j,rt){_=_>>>0,j=j>>>0,rt||It(_,j,this.length);let ut=j,ht=1,gt=this[_+--ut];for(;ut>0&&(ht*=256);)gt+=this[_+--ut]*ht;return ht*=128,gt>=ht&&(gt-=Math.pow(2,8*j)),gt},g.prototype.readInt8=function(_,j){return _=_>>>0,j||It(_,1,this.length),this[_]&128?(255-this[_]+1)*-1:this[_]},g.prototype.readInt16LE=function(_,j){_=_>>>0,j||It(_,2,this.length);const rt=this[_]|this[_+1]<<8;return rt&32768?rt|4294901760:rt},g.prototype.readInt16BE=function(_,j){_=_>>>0,j||It(_,2,this.length);const rt=this[_+1]|this[_]<<8;return rt&32768?rt|4294901760:rt},g.prototype.readInt32LE=function(_,j){return _=_>>>0,j||It(_,4,this.length),this[_]|this[_+1]<<8|this[_+2]<<16|this[_+3]<<24},g.prototype.readInt32BE=function(_,j){return _=_>>>0,j||It(_,4,this.length),this[_]<<24|this[_+1]<<16|this[_+2]<<8|this[_+3]},g.prototype.readBigInt64LE=un(function(_){_=_>>>0,cn(_,"offset");const j=this[_],rt=this[_+7];(j===void 0||rt===void 0)&&xn(_,this.length-8);const ut=this[_+4]+this[_+5]*2**8+this[_+6]*2**16+(rt<<24);return(BigInt(ut)<<BigInt(32))+BigInt(j+this[++_]*2**8+this[++_]*2**16+this[++_]*2**24)}),g.prototype.readBigInt64BE=un(function(_){_=_>>>0,cn(_,"offset");const j=this[_],rt=this[_+7];(j===void 0||rt===void 0)&&xn(_,this.length-8);const ut=(j<<24)+this[++_]*2**16+this[++_]*2**8+this[++_];return(BigInt(ut)<<BigInt(32))+BigInt(this[++_]*2**24+this[++_]*2**16+this[++_]*2**8+rt)}),g.prototype.readFloatLE=function(_,j){return _=_>>>0,j||It(_,4,this.length),a.read(this,_,!0,23,4)},g.prototype.readFloatBE=function(_,j){return _=_>>>0,j||It(_,4,this.length),a.read(this,_,!1,23,4)},g.prototype.readDoubleLE=function(_,j){return _=_>>>0,j||It(_,8,this.length),a.read(this,_,!0,52,8)},g.prototype.readDoubleBE=function(_,j){return _=_>>>0,j||It(_,8,this.length),a.read(this,_,!1,52,8)};function Dt(_e,_,j,rt,ut,ht){if(!g.isBuffer(_e))throw new TypeError('"buffer" argument must be a Buffer instance');if(_>ut||_<ht)throw new RangeError('"value" argument is out of bounds');if(j+rt>_e.length)throw new RangeError("Index out of range")}g.prototype.writeUintLE=g.prototype.writeUIntLE=function(_,j,rt,ut){if(_=+_,j=j>>>0,rt=rt>>>0,!ut){const Ft=Math.pow(2,8*rt)-1;Dt(this,_,j,rt,Ft,0)}let ht=1,gt=0;for(this[j]=_&255;++gt<rt&&(ht*=256);)this[j+gt]=_/ht&255;return j+rt},g.prototype.writeUintBE=g.prototype.writeUIntBE=function(_,j,rt,ut){if(_=+_,j=j>>>0,rt=rt>>>0,!ut){const Ft=Math.pow(2,8*rt)-1;Dt(this,_,j,rt,Ft,0)}let ht=rt-1,gt=1;for(this[j+ht]=_&255;--ht>=0&&(gt*=256);)this[j+ht]=_/gt&255;return j+rt},g.prototype.writeUint8=g.prototype.writeUInt8=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,1,255,0),this[j]=_&255,j+1},g.prototype.writeUint16LE=g.prototype.writeUInt16LE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,2,65535,0),this[j]=_&255,this[j+1]=_>>>8,j+2},g.prototype.writeUint16BE=g.prototype.writeUInt16BE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,2,65535,0),this[j]=_>>>8,this[j+1]=_&255,j+2},g.prototype.writeUint32LE=g.prototype.writeUInt32LE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,4,4294967295,0),this[j+3]=_>>>24,this[j+2]=_>>>16,this[j+1]=_>>>8,this[j]=_&255,j+4},g.prototype.writeUint32BE=g.prototype.writeUInt32BE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,4,4294967295,0),this[j]=_>>>24,this[j+1]=_>>>16,this[j+2]=_>>>8,this[j+3]=_&255,j+4};function sn(_e,_,j,rt,ut){nn(_,rt,ut,_e,j,7);let ht=Number(_&BigInt(4294967295));_e[j++]=ht,ht=ht>>8,_e[j++]=ht,ht=ht>>8,_e[j++]=ht,ht=ht>>8,_e[j++]=ht;let gt=Number(_>>BigInt(32)&BigInt(4294967295));return _e[j++]=gt,gt=gt>>8,_e[j++]=gt,gt=gt>>8,_e[j++]=gt,gt=gt>>8,_e[j++]=gt,j}function on(_e,_,j,rt,ut){nn(_,rt,ut,_e,j,7);let ht=Number(_&BigInt(4294967295));_e[j+7]=ht,ht=ht>>8,_e[j+6]=ht,ht=ht>>8,_e[j+5]=ht,ht=ht>>8,_e[j+4]=ht;let gt=Number(_>>BigInt(32)&BigInt(4294967295));return _e[j+3]=gt,gt=gt>>8,_e[j+2]=gt,gt=gt>>8,_e[j+1]=gt,gt=gt>>8,_e[j]=gt,j+8}g.prototype.writeBigUInt64LE=un(function(_,j=0){return sn(this,_,j,BigInt(0),BigInt("0xffffffffffffffff"))}),g.prototype.writeBigUInt64BE=un(function(_,j=0){return on(this,_,j,BigInt(0),BigInt("0xffffffffffffffff"))}),g.prototype.writeIntLE=function(_,j,rt,ut){if(_=+_,j=j>>>0,!ut){const Gt=Math.pow(2,8*rt-1);Dt(this,_,j,rt,Gt-1,-Gt)}let ht=0,gt=1,Ft=0;for(this[j]=_&255;++ht<rt&&(gt*=256);)_<0&&Ft===0&&this[j+ht-1]!==0&&(Ft=1),this[j+ht]=(_/gt>>0)-Ft&255;return j+rt},g.prototype.writeIntBE=function(_,j,rt,ut){if(_=+_,j=j>>>0,!ut){const Gt=Math.pow(2,8*rt-1);Dt(this,_,j,rt,Gt-1,-Gt)}let ht=rt-1,gt=1,Ft=0;for(this[j+ht]=_&255;--ht>=0&&(gt*=256);)_<0&&Ft===0&&this[j+ht+1]!==0&&(Ft=1),this[j+ht]=(_/gt>>0)-Ft&255;return j+rt},g.prototype.writeInt8=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,1,127,-128),_<0&&(_=255+_+1),this[j]=_&255,j+1},g.prototype.writeInt16LE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,2,32767,-32768),this[j]=_&255,this[j+1]=_>>>8,j+2},g.prototype.writeInt16BE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,2,32767,-32768),this[j]=_>>>8,this[j+1]=_&255,j+2},g.prototype.writeInt32LE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,4,2147483647,-2147483648),this[j]=_&255,this[j+1]=_>>>8,this[j+2]=_>>>16,this[j+3]=_>>>24,j+4},g.prototype.writeInt32BE=function(_,j,rt){return _=+_,j=j>>>0,rt||Dt(this,_,j,4,2147483647,-2147483648),_<0&&(_=4294967295+_+1),this[j]=_>>>24,this[j+1]=_>>>16,this[j+2]=_>>>8,this[j+3]=_&255,j+4},g.prototype.writeBigInt64LE=un(function(_,j=0){return sn(this,_,j,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))}),g.prototype.writeBigInt64BE=un(function(_,j=0){return on(this,_,j,-BigInt("0x8000000000000000"),BigInt("0x7fffffffffffffff"))});function en(_e,_,j,rt,ut,ht){if(j+rt>_e.length)throw new RangeError("Index out of range");if(j<0)throw new RangeError("Index out of range")}function tn(_e,_,j,rt,ut){return _=+_,j=j>>>0,ut||en(_e,_,j,4),a.write(_e,_,j,rt,23,4),j+4}g.prototype.writeFloatLE=function(_,j,rt){return tn(this,_,j,!0,rt)},g.prototype.writeFloatBE=function(_,j,rt){return tn(this,_,j,!1,rt)};function an(_e,_,j,rt,ut){return _=+_,j=j>>>0,ut||en(_e,_,j,8),a.write(_e,_,j,rt,52,8),j+8}g.prototype.writeDoubleLE=function(_,j,rt){return an(this,_,j,!0,rt)},g.prototype.writeDoubleBE=function(_,j,rt){return an(this,_,j,!1,rt)},g.prototype.copy=function(_,j,rt,ut){if(!g.isBuffer(_))throw new TypeError("argument should be a Buffer");if(rt||(rt=0),!ut&&ut!==0&&(ut=this.length),j>=_.length&&(j=_.length),j||(j=0),ut>0&&ut<rt&&(ut=rt),ut===rt||_.length===0||this.length===0)return 0;if(j<0)throw new RangeError("targetStart out of bounds");if(rt<0||rt>=this.length)throw new RangeError("Index out of range");if(ut<0)throw new RangeError("sourceEnd out of bounds");ut>this.length&&(ut=this.length),_.length-j<ut-rt&&(ut=_.length-j+rt);const ht=ut-rt;return this===_&&typeof Uint8Array.prototype.copyWithin=="function"?this.copyWithin(j,rt,ut):Uint8Array.prototype.set.call(_,this.subarray(rt,ut),j),ht},g.prototype.fill=function(_,j,rt,ut){if(typeof _=="string"){if(typeof j=="string"?(ut=j,j=0,rt=this.length):typeof rt=="string"&&(ut=rt,rt=this.length),ut!==void 0&&typeof ut!="string")throw new TypeError("encoding must be a string");if(typeof ut=="string"&&!g.isEncoding(ut))throw new TypeError("Unknown encoding: "+ut);if(_.length===1){const gt=_.charCodeAt(0);(ut==="utf8"&&gt<128||ut==="latin1")&&(_=gt)}}else typeof _=="number"?_=_&255:typeof _=="boolean"&&(_=Number(_));if(j<0||this.length<j||this.length<rt)throw new RangeError("Out of range index");if(rt<=j)return this;j=j>>>0,rt=rt===void 0?this.length:rt>>>0,_||(_=0);let ht;if(typeof _=="number")for(ht=j;ht<rt;++ht)this[ht]=_;else{const gt=g.isBuffer(_)?_:g.from(_,ut),Ft=gt.length;if(Ft===0)throw new TypeError('The value "'+_+'" is invalid for argument "value"');for(ht=0;ht<rt-j;++ht)this[ht+j]=gt[ht%Ft]}return this};const fn={};function Cn(_e,_,j){fn[_e]=class extends j{constructor(){super(),Object.defineProperty(this,"message",{value:_.apply(this,arguments),writable:!0,configurable:!0}),this.name=`${this.name} [${_e}]`,this.stack,delete this.name}get code(){return _e}set code(ut){Object.defineProperty(this,"code",{configurable:!0,enumerable:!0,value:ut,writable:!0})}toString(){return`${this.name} [${_e}]: ${this.message}`}}}Cn("ERR_BUFFER_OUT_OF_BOUNDS",function(_e){return _e?`${_e} is outside of buffer bounds`:"Attempt to access memory outside buffer bounds"},RangeError),Cn("ERR_INVALID_ARG_TYPE",function(_e,_){return`The "${_e}" argument must be of type number. Received type ${typeof _}`},TypeError),Cn("ERR_OUT_OF_RANGE",function(_e,_,j){let rt=`The value of "${_e}" is out of range.`,ut=j;return Number.isInteger(j)&&Math.abs(j)>2**32?ut=jn(String(j)):typeof j=="bigint"&&(ut=String(j),(j>BigInt(2)**BigInt(32)||j<-(BigInt(2)**BigInt(32)))&&(ut=jn(ut)),ut+="n"),rt+=` It must be ${_}. Received ${ut}`,rt},RangeError);function jn(_e){let _="",j=_e.length;const rt=_e[0]==="-"?1:0;for(;j>=rt+4;j-=3)_=`_${_e.slice(j-3,j)}${_}`;return`${_e.slice(0,j)}${_}`}function Un(_e,_,j){cn(_,"offset"),(_e[_]===void 0||_e[_+j]===void 0)&&xn(_,_e.length-(j+1))}function nn(_e,_,j,rt,ut,ht){if(_e>j||_e<_){const gt=typeof _=="bigint"?"n":"";let Ft;throw _===0||_===BigInt(0)?Ft=`>= 0${gt} and < 2${gt} ** ${(ht+1)*8}${gt}`:Ft=`>= -(2${gt} ** ${(ht+1)*8-1}${gt}) and < 2 ** ${(ht+1)*8-1}${gt}`,new fn.ERR_OUT_OF_RANGE("value",Ft,_e)}Un(rt,ut,ht)}function cn(_e,_){if(typeof _e!="number")throw new fn.ERR_INVALID_ARG_TYPE(_,"number",_e)}function xn(_e,_,j){throw Math.floor(_e)!==_e?(cn(_e,j),new fn.ERR_OUT_OF_RANGE("offset","an integer",_e)):_<0?new fn.ERR_BUFFER_OUT_OF_BOUNDS:new fn.ERR_OUT_OF_RANGE("offset",`>= 0 and <= ${_}`,_e)}const $n=/[^+/0-9A-Za-z-_]/g;function gn(_e){if(_e=_e.split("=")[0],_e=_e.trim().replace($n,""),_e.length<2)return"";for(;_e.length%4!==0;)_e=_e+"=";return _e}function Rn(_e,_){_=_||1/0;let j;const rt=_e.length;let ut=null;const ht=[];for(let gt=0;gt<rt;++gt){if(j=_e.charCodeAt(gt),j>55295&&j<57344){if(!ut){if(j>56319){(_-=3)>-1&&ht.push(239,191,189);continue}else if(gt+1===rt){(_-=3)>-1&&ht.push(239,191,189);continue}ut=j;continue}if(j<56320){(_-=3)>-1&&ht.push(239,191,189),ut=j;continue}j=(ut-55296<<10|j-56320)+65536}else ut&&(_-=3)>-1&&ht.push(239,191,189);if(ut=null,j<128){if((_-=1)<0)break;ht.push(j)}else if(j<2048){if((_-=2)<0)break;ht.push(j>>6|192,j&63|128)}else if(j<65536){if((_-=3)<0)break;ht.push(j>>12|224,j>>6&63|128,j&63|128)}else if(j<1114112){if((_-=4)<0)break;ht.push(j>>18|240,j>>12&63|128,j>>6&63|128,j&63|128)}else throw new Error("Invalid code point")}return ht}function zn(_e){const _=[];for(let j=0;j<_e.length;++j)_.push(_e.charCodeAt(j)&255);return _}function Ln(_e,_){let j,rt,ut;const ht=[];for(let gt=0;gt<_e.length&&!((_-=2)<0);++gt)j=_e.charCodeAt(gt),rt=j>>8,ut=j%256,ht.push(ut),ht.push(rt);return ht}function In(_e){return o.toByteArray(gn(_e))}function _n(_e,_,j,rt){let ut;for(ut=0;ut<rt&&!(ut+j>=_.length||ut>=_e.length);++ut)_[ut+j]=_e[ut];return ut}function dn(_e,_){return _e instanceof _||_e!=null&&_e.constructor!=null&&_e.constructor.name!=null&&_e.constructor.name===_.name}function Pn(_e){return _e!==_e}const yn=function(){const _e="0123456789abcdef",_=new Array(256);for(let j=0;j<16;++j){const rt=j*16;for(let ut=0;ut<16;++ut)_[rt+ut]=_e[j]+_e[ut]}return _}();function un(_e){return typeof BigInt>"u"?Mn:_e}function Mn(){throw new Error("BigInt not supported")}})(buffer);var client={},reactDom={exports:{}},reactDom_production_min={},scheduler={exports:{}},scheduler_production_min={};/**
 * @license React
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function o(wt,Lt){var Mt=wt.length;wt.push(Lt);e:for(;0<Mt;){var It=Mt-1>>>1,Dt=wt[It];if(0<c(Dt,Lt))wt[It]=Lt,wt[Mt]=Dt,Mt=It;else break e}}function a(wt){return wt.length===0?null:wt[0]}function s(wt){if(wt.length===0)return null;var Lt=wt[0],Mt=wt.pop();if(Mt!==Lt){wt[0]=Mt;e:for(var It=0,Dt=wt.length,sn=Dt>>>1;It<sn;){var on=2*(It+1)-1,en=wt[on],tn=on+1,an=wt[tn];if(0>c(en,Mt))tn<Dt&&0>c(an,en)?(wt[It]=an,wt[tn]=Mt,It=tn):(wt[It]=en,wt[on]=Mt,It=on);else if(tn<Dt&&0>c(an,Mt))wt[It]=an,wt[tn]=Mt,It=tn;else break e}}return Lt}function c(wt,Lt){var Mt=wt.sortIndex-Lt.sortIndex;return Mt!==0?Mt:wt.id-Lt.id}if(typeof performance=="object"&&typeof performance.now=="function"){var d=performance;e.unstable_now=function(){return d.now()}}else{var h=Date,g=h.now();e.unstable_now=function(){return h.now()-g}}var b=[],$=[],tt=1,et=null,nt=3,ot=!1,ft=!1,pt=!1,vt=typeof setTimeout=="function"?setTimeout:null,lt=typeof clearTimeout=="function"?clearTimeout:null,it=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function st(wt){for(var Lt=a($);Lt!==null;){if(Lt.callback===null)s($);else if(Lt.startTime<=wt)s($),Lt.sortIndex=Lt.expirationTime,o(b,Lt);else break;Lt=a($)}}function yt(wt){if(pt=!1,st(wt),!ft)if(a(b)!==null)ft=!0,pn(_t);else{var Lt=a($);Lt!==null&&hn(yt,Lt.startTime-wt)}}function _t(wt,Lt){ft=!1,pt&&(pt=!1,lt(Et),Et=-1),ot=!0;var Mt=nt;try{for(st(Lt),et=a(b);et!==null&&(!(et.expirationTime>Lt)||wt&&!zt());){var It=et.callback;if(typeof It=="function"){et.callback=null,nt=et.priorityLevel;var Dt=It(et.expirationTime<=Lt);Lt=e.unstable_now(),typeof Dt=="function"?et.callback=Dt:et===a(b)&&s(b),st(Lt)}else s(b);et=a(b)}if(et!==null)var sn=!0;else{var on=a($);on!==null&&hn(yt,on.startTime-Lt),sn=!1}return sn}finally{et=null,nt=Mt,ot=!1}}var Ct=!1,ct=null,Et=-1,jt=5,kt=-1;function zt(){return!(e.unstable_now()-kt<jt)}function Wt(){if(ct!==null){var wt=e.unstable_now();kt=wt;var Lt=!0;try{Lt=ct(!0,wt)}finally{Lt?qt():(Ct=!1,ct=null)}}else Ct=!1}var qt;if(typeof it=="function")qt=function(){it(Wt)};else if(typeof MessageChannel<"u"){var Jt=new MessageChannel,ln=Jt.port2;Jt.port1.onmessage=Wt,qt=function(){ln.postMessage(null)}}else qt=function(){vt(Wt,0)};function pn(wt){ct=wt,Ct||(Ct=!0,qt())}function hn(wt,Lt){Et=vt(function(){wt(e.unstable_now())},Lt)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(wt){wt.callback=null},e.unstable_continueExecution=function(){ft||ot||(ft=!0,pn(_t))},e.unstable_forceFrameRate=function(wt){0>wt||125<wt?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):jt=0<wt?Math.floor(1e3/wt):5},e.unstable_getCurrentPriorityLevel=function(){return nt},e.unstable_getFirstCallbackNode=function(){return a(b)},e.unstable_next=function(wt){switch(nt){case 1:case 2:case 3:var Lt=3;break;default:Lt=nt}var Mt=nt;nt=Lt;try{return wt()}finally{nt=Mt}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(wt,Lt){switch(wt){case 1:case 2:case 3:case 4:case 5:break;default:wt=3}var Mt=nt;nt=wt;try{return Lt()}finally{nt=Mt}},e.unstable_scheduleCallback=function(wt,Lt,Mt){var It=e.unstable_now();switch(typeof Mt=="object"&&Mt!==null?(Mt=Mt.delay,Mt=typeof Mt=="number"&&0<Mt?It+Mt:It):Mt=It,wt){case 1:var Dt=-1;break;case 2:Dt=250;break;case 5:Dt=1073741823;break;case 4:Dt=1e4;break;default:Dt=5e3}return Dt=Mt+Dt,wt={id:tt++,callback:Lt,priorityLevel:wt,startTime:Mt,expirationTime:Dt,sortIndex:-1},Mt>It?(wt.sortIndex=Mt,o($,wt),a(b)===null&&wt===a($)&&(pt?(lt(Et),Et=-1):pt=!0,hn(yt,Mt-It))):(wt.sortIndex=Dt,o(b,wt),ft||ot||(ft=!0,pn(_t))),wt},e.unstable_shouldYield=zt,e.unstable_wrapCallback=function(wt){var Lt=nt;return function(){var Mt=nt;nt=Lt;try{return wt.apply(this,arguments)}finally{nt=Mt}}}})(scheduler_production_min);scheduler.exports=scheduler_production_min;var schedulerExports=scheduler.exports;/**
 * @license React
...
team_members:
  ...
  - name: Andrii Osmak
    title: Engineering Manager
    photo: /roadmap/images/SCR-20260410-jicp.png
...
gantt_items:
  - title: Gold Société via LEBT
    start_date: 2026-04-01
    end_date: 2026-05-01
  - title: Self service flights
    start_date: 2026-04-01
    end_date: 2026-06-26
  - title: Policy set up restructure
    start_date: 2026-05-04
    end_date: 2026-07-03
  - title: Single sign on
    start_date: 2026-06-15
    end_date: 2026-07-03
  - title: Increase corporate rate hotel supply
    start_date: 2026-04-01
    end_date: 2026-12-31
goals:
...
key_initiatives:
  - heading: Corporate rate hotel supply
    description: We're integrating Sabre as an additional hotel supplier for LEBT,
      expanding the business benefits to our customers, such as business rates
      and the ability to earn hotel loyalty points on business hotel bookings.
      Sabre is a Global Distribution System (GDS) used widely across the
      corporate travel industry, so this integration positions LEBT alongside
      the standard expected by business travel programs. LEBT will also
      investigate expanding its corporate rate hotel supply to other GDSs and
      also LE’s own LPC rates.
  - heading: Gold Société status attainable through LEBT
    description: One of the most exciting perks being brought to LEBT customers is
      the ability to earn Gold Société status through their LEBT bookings.
      Société is Luxury Escapes' loyalty program, and Gold status unlocks a
      range of premium benefits for members. Connecting LEBT bookings to
      attaining Gold Société status gives business travellers a meaningful
      personal incentive to book through the platform rather than outside it.
      This strengthens LEBT's value proposition while also encouraging customers
      to book holidays on Luxury Escapes, creating a powerful dual benefit for
      the group.
  - heading: Policy Set Up Restructure
    description: Travel policy management is one of the most critical parts of
      running a business travel program, and we're rebuilding LEBT's policy
      infrastructure to match the needs of businesses. We're introducing a ‘User
      Groups’ framework so that admins can assign policies to groups of
      employees rather than configuring each traveller individually, making
      onboarding faster and ongoing management far less manual. Item policies
      are being evolved to support different travel policies and booking rules
      for different employees and/or groups; while approval policy workflows are
      being rearchitected to support more flexible and scalable workflows.
      Together, these changes make LEBT capable of serving a much broader range
      of business customers, from small teams with simple needs to large
      enterprises with complex organisational structures.
---
`,__vite_glob_0_6=`---
...
key_initiatives:
  - heading: A Truly Global Luxury Experience
    description: Expand localisation across the app so international customers see a
      more relevant, trustworthy and seamless experience. This includes
      foundations like language, currency, date formats and region-specific
      content, helping more customers discover and book with confidence.
  - heading: Effortless Booking, End-to-End
    description: Make the journey from discovery to purchase smoother by reducing
      friction across key booking moments. This includes improving high-drop-off
      steps, creating better handover points between app and website, and making
      webview-based flows feel more connected and native.
  - heading: Smarter Discovery & Search
    description: Refresh the way customers search and discover travel so finding the
      right escape feels faster, easier and more intuitive. This includes
      improving the core search experience, leaning further into Natural
      Language Search, and bringing more discovery journeys natively into the
      app.
  - heading: Personalised Inspiration & Content
    description: Make the app a stronger destination for inspiration by bringing
      together more personalised offers, editorial content and curated
      recommendations. The goal is to give customers more relevant reasons to
      return, even when they are not yet ready to book.
  - heading: The App as a Travel Companion
    description: Grow the app beyond booking into a more useful companion throughout
      the travel journey. This includes surfacing clearer trip details, timely
      travel updates and more accessible support, so customers rely on the app
...
team_members:
  ...
  - name: Sam Hammond
    title: Engineering Manager
    photo: /roadmap/images/TCWH2EC6L-U04QVNMBWA2-368233cd8be3-512.png
gantt_items:
  - title: Placeholder content
    start_date: 2026-04-01
    end_date: 2026-06-30
...
goals:
  - headline: Support multi-destination and complex itinerary planning
    description: TripPlanner users skew towards complicated multi-destination trips
      → Tool can make recommendations based on full customer plan and complex
      travel needs
  - headline: Expand TripPlanner reach and discoverability
    description: MVP is desktop-only with limited awareness → Available on mobile
      web with active product marketing driving adoption
  - headline: Enable trip collaboration and sharing
    description: Current sharing capabilities limited → Customers can easily share
      trips with travel companions
key_initiatives:
  - heading: Chat TripPlanner on Mobile Web
    description: The MVP is currently desktop-only. Building mobile web support is
      critical to reach more customers and ensure the TripPlanner experience is
      available across all devices. This is the highest priority for expanding
      TripPlanner's reach and enabling more customers to benefit from the
      AI-powered planning tool.
  - heading: Lean More Into NLS
    description: The natural language search experience in TripPlanner is very
      compelling, especially with how customers can ask follow-up questions and
      use the map. Making TripPlanner a much stronger agentic discovery tool
      that helps customers explore and plan complex, multi-destination trips
      more naturally. This is highly experimental but has significant promise
      for increasing engagement and conversion.
  - heading: Recommend Offers Based on Trip
    description: TripPlanner users skew towards more complicated, multi-destination
      trips which Luxury Escapes doesn't currently handle as well as needed.
      Building capability to recommend hotels, flights, and experiences based on
      the customer's full trip plan will help convert more complex itineraries
      and increase multi-product attach rates.
---
`,__vite_glob_0_29=`---
title: "Voice AI"
slug: "voice-ai"
