 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function o(wt,Lt){var Mt=wt.length;wt.push(Lt);e:for(;0<Mt;){var It=Mt-1>>>1,Dt=wt[It];if(0<c(Dt,Lt))wt[It]=Lt,wt[Mt]=Dt,Mt=It;else break e}}function a(wt){return wt.length===0?null:wt[0]}function s(wt){if(wt.length===0)return null;var Lt=wt[0],Mt=wt.pop();if(Mt!==Lt){wt[0]=Mt;e:for(var It=0,Dt=wt.length,sn=Dt>>>1;It<sn;){var on=2*(It+1)-1,en=wt[on],tn=on+1,an=wt[tn];if(0>c(en,Mt))tn<Dt&&0>c(an,en)?(wt[It]=an,wt[tn]=Mt,It=tn):(wt[It]=en,wt[on]=Mt,It=on);else if(tn<Dt&&0>c(an,Mt))wt[It]=an,wt[tn]=Mt,It=tn;else break e}}return Lt}function c(wt,Lt){var Mt=wt.sortIndex-Lt.sortIndex;return Mt!==0?Mt:wt.id-Lt.id}if(typeof performance=="object"&&typeof performance.now=="function"){var d=performance;e.unstable_now=function(){return d.now()}}else{var h=Date,g=h.now();e.unstable_now=function(){return h.now()-g}}var b=[],$=[],tt=1,et=null,rt=3,ot=!1,ft=!1,pt=!1,vt=typeof setTimeout=="function"?setTimeout:null,lt=typeof clearTimeout=="function"?clearTimeout:null,it=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function st(wt){for(var Lt=a($);Lt!==null;){if(Lt.callback===null)s($);else if(Lt.startTime<=wt)s($),Lt.sortIndex=Lt.expirationTime,o(b,Lt);else break;Lt=a($)}}function yt(wt){if(pt=!1,st(wt),!ft)if(a(b)!==null)ft=!0,pn(Et);else{var Lt=a($);Lt!==null&&hn(yt,Lt.startTime-wt)}}function Et(wt,Lt){ft=!1,pt&&(pt=!1,lt(_t),_t=-1),ot=!0;var Mt=rt;try{for(st(Lt),et=a(b);et!==null&&(!(et.expirationTime>Lt)||wt&&!zt());){var It=et.callback;if(typeof It=="function"){et.callback=null,rt=et.priorityLevel;var Dt=It(et.expirationTime<=Lt);Lt=e.unstable_now(),typeof Dt=="function"?et.callback=Dt:et===a(b)&&s(b),st(Lt)}else s(b);et=a(b)}if(et!==null)var sn=!0;else{var on=a($);on!==null&&hn(yt,on.startTime-Lt),sn=!1}return sn}finally{et=null,rt=Mt,ot=!1}}var Ct=!1,ct=null,_t=-1,jt=5,kt=-1;function zt(){return!(e.unstable_now()-kt<jt)}function Wt(){if(ct!==null){var wt=e.unstable_now();kt=wt;var Lt=!0;try{Lt=ct(!0,wt)}finally{Lt?qt():(Ct=!1,ct=null)}}else Ct=!1}var qt;if(typeof it=="function")qt=function(){it(Wt)};else if(typeof MessageChannel<"u"){var Jt=new MessageChannel,ln=Jt.port2;Jt.port1.onmessage=Wt,qt=function(){ln.postMessage(null)}}else qt=function(){vt(Wt,0)};function pn(wt){ct=wt,Ct||(Ct=!0,qt())}function hn(wt,Lt){_t=vt(function(){wt(e.unstable_now())},Lt)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(wt){wt.callback=null},e.unstable_continueExecution=function(){ft||ot||(ft=!0,pn(Et))},e.unstable_forceFrameRate=function(wt){0>wt||125<wt?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):jt=0<wt?Math.floor(1e3/wt):5},e.unstable_getCurrentPriorityLevel=function(){return rt},e.unstable_getFirstCallbackNode=function(){return a(b)},e.unstable_next=function(wt){switch(rt){case 1:case 2:case 3:var Lt=3;break;default:Lt=rt}var Mt=rt;rt=Lt;try{return wt()}finally{rt=Mt}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(wt,Lt){switch(wt){case 1:case 2:case 3:case 4:case 5:break;default:wt=3}var Mt=rt;rt=wt;try{return Lt()}finally{rt=Mt}},e.unstable_scheduleCallback=function(wt,Lt,Mt){var It=e.unstable_now();switch(typeof Mt=="object"&&Mt!==null?(Mt=Mt.delay,Mt=typeof Mt=="number"&&0<Mt?It+Mt:It):Mt=It,wt){case 1:var Dt=-1;break;case 2:Dt=250;break;case 5:Dt=1073741823;break;case 4:Dt=1e4;break;default:Dt=5e3}return Dt=Mt+Dt,wt={id:tt++,callback:Lt,priorityLevel:wt,startTime:Mt,expirationTime:Dt,sortIndex:-1},Mt>It?(wt.sortIndex=Mt,o($,wt),a(b)===null&&wt===a($)&&(pt?(lt(_t),_t=-1):pt=!0,hn(yt,Mt-It))):(wt.sortIndex=Dt,o(b,wt),ft||ot||(ft=!0,pn(Et))),wt},e.unstable_shouldYield=zt,e.unstable_wrapCallback=function(wt){var Lt=rt;return function(){var Mt=rt;rt=Lt;try{return wt.apply(this,arguments)}finally{rt=Mt}}}})(scheduler_production_min);scheduler.exports=scheduler_production_min;var schedulerExports=scheduler.exports;/**
 * @license React
